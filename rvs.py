...
if 1:
    ...
    plt.errorbar(c_mjdobs_list,c_good_rv_list,yerr=c_rvsig_list,fmt="x",color="red",label="c Measured raw RV ($1\sigma$)")
    ...
    plt.errorbar(b_mjdobs_list,b_good_rv_list,yerr=b_rvsig_list,fmt="x",color="green",label="b Measured raw RV ($1\sigma$)")
    ...
    plt.errorbar(c_mjdobs_list,c_good_rv_list-c_bary_star_list,yerr=c_rvsig_list,fmt="x",color="red",label="c Estimated Planet RV ($1\sigma$)")
    ...
    plt.errorbar(b_mjdobs_list,b_good_rv_list-b_bary_star_list,yerr=b_rvsig_list,fmt="x",color="green",label="b Estimated Planet RV ($1\sigma$)")
    ...
    plt.figure(2)
    where_b = np.where(np.isfinite(b_good_rv_list)*(b_mjdobs_list > 55388)*(b_mjdobs_list < 55394))
    plt.hist(b_good_rv_list[where_b]-b_bary_star_list[where_b], label="b")
    where_c = np.where(np.isfinite(c_good_rv_list)*(c_mjdobs_list > 55388)*(c_mjdobs_list < 55394))
    plt.hist(c_good_rv_list[where_c]-c_bary_star_list[where_c], label="c")
    plt.legend()
