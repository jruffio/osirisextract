...
if __name__ == "__main__":
    ...
    if 1:
        ...
        for planet,planetcolor in zip(["d"],["#6600ff"]):
            for IFSfilter in ["Kbb"]:
                ...
                filenamefilter = "s*"+IFSfilter+"*_data.fits"
                ...
                for data_filename in data_filelist:
                    print(data_filename)
                    with pyfits.open(data_filename.replace("20190508_models2","20190510_spec_esti").replace("_data.fits","_outputHPF_cutoff40_sherlock_v1_search_estispec.fits")) as hdulist:
                    ...
                    fileid = filelist.index(os.path.basename(data_filename).replace("_data.fits",".fits"))
